...
class Snake:
    def __init__(self, parent_screen, lenght):
        self.lenght = lenght
        self.parent_screen = parent_screen
        self.block = pygame.image.load("resources/snake.jpeg").convert()
        self.block = pygame.transform.scale(self.block, (42, 42))
        self.x = [SIZE] * lenght
        self.y = [SIZE] * lenght
        self.direction = 'down'
...
class Game:
    ...
    def display_score(self):
        ...
        score = font.render(
            f"Score: {self.snake.lenght}", True, (200, 200, 200))
    ...
    def show_game_over(self):
        ...
        line2 = font.render("To play again press Enter", True, (200, 200, 200))
